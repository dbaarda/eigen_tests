...
// configuration step. It creates a namespace called `eigen_tests`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", eigen_tests::cmake::project_name, eigen_tests::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", eigen_tests::cmake::project_version);
      return EXIT_SUCCESS;
    }
